...
+'<p><img src="https://i.postimg.cc/MT0XbnCz/abd.png" width="360px"><figcaption><i>Абстракция данных</i> - это возможность определять новые типы данных, '
...
+'<p><img src="https://i.postimg.cc/vHhq2XrV/nasl.png" width="350px" heigth="300px"><figcaption><i>Наследование</i> - процесс при котором один объект приобретает свйоства '
+'другого.</figcaption></p><br>'
	+'<p><img src="https://i.postimg.cc/wx2Y0zbW/image.png" widthy="300px"><figcaption><i>Полиморфизм</i> - поведение '
...
+'</table><ol><h4>Конструкторы и деструкторы</h4> <br>'
